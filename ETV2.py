...
class BinaryNode(Expression):
    ...
    def __str__(self):
        ...
        if isint(str(self.lhs)) and isint(str(self.rhs)) and\
           int(float(str(self.lhs)))==0 and int(float(str(self.lhs)))==0:
            # Returns '0'
            return str(0)
